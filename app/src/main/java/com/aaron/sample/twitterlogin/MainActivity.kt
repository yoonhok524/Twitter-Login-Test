    ...
    private fun authFirebaseTwitter() {
        ...
        firebaseAuth
            ...
            .addOnSuccessListener { authResult ->
                ...
                Log.d(TAG, "[test] success - ${authResult.user?.email}")
                Log.d(TAG, "[test] success - ${authResult.user?.providerData}")

                Log.d(TAG, "[test] success - user: ${firebaseAuth.currentUser?.photoUrl}")
                toast("Success")
            }
